...
public static final Uri CONTENT_URI= Uri.parse("content://com.example.RNGD.LBProvider/elements");
    ...
    public static final String KEY_SELECTEDIMG="selected";
    ...
    public static final String DATABASE_CREATE="CREATE TABLE "+DATABASE_TABLE+" ("+KEY_ID+" INTEGER PRIMARY KEY, "+KEY_DATE+" TEXT, "+KEY_TITLE+" TEXT, "+KEY_BODY+" TEXT, "+KEY_IMAGES+" TEXT, "+KEY_SELECTEDIMG+" TEXT, "+KEY_TAG+" TEXT);";
